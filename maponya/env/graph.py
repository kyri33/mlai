...
class ENVGraph:
    ...
    def render(self, current_step, net_worth, trades, balance, holding, window_size=60):
    ...
    def _render_net_worth(self, current_step, step_range):
    ...
    def _render_price(self, current_step, step_range):
        ...
        candlesticks = zip(step_range, self.df['Open'].values[step_range],
                self.df['Close'].values[step_range], self.df['High'].values[step_range],
    ...
    def _render_trades(self, current_step, trades, step_range):
        for trade in trades:
            if trade['step'] in step_range:
                ...
                self.price_ax.annotate(f'${total}', (trade['step'], high_low),
